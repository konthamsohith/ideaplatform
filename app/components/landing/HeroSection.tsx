    ...
    return (
        <section className="hero-section" style={{ background: '#ffffff', position: 'relative', marginTop: '-2rem' }}>
            ...
            >
                ...
                <motion.p variants={itemVariants} className="hero-subtitle" style={{ marginBottom: '1.5rem', maxWidth: '800px' }}>
                ...
                <motion.div variants={itemVariants} className="workspace-mockup" style={{
                    ...
                    <div style={{ padding: '0rem 1rem 1rem 1rem', width: '100%', background: '#F8FAF6', display: 'flex', flex: 1 }}>
                        <div className="mockup-body" style={{ width: '100%', height: '100%', border: '1px solid #e2e8f0', borderRadius: '16px', overflow: 'hidden', background: '#ffffff', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                            {/* Sidebar */}
                            ...
                            <main className="mockup-content" style={{ position: 'relative', display: 'flex', flexDirection: 'column', background: '#F9FAFB' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                                        <h3 style={{ fontSize: '1.25rem', fontWeight: 600, letterSpacing: '-0.03em', lineHeight: '1', color: '#0f172a', marginBottom: '0.25rem' }}>Idea Control Center</h3>
